...
<<<<<<< HEAD
  `LetzteDvD` varchar(30) DEFAULT NULL,
...
LOAD DATA LOCAL INFILE '/kunden/homepages/22/d13466979/htdocs/admin/SicherungData/Mitglieder2.txt'
REPLACE
...
Telefon2,HandyNr,LetzteDvD,@LetzteAenderung,Email,Beruf,Nationalitaet,BLZ,Bank,KontoNr,`Status`,AktivPassiv,
...
SET GeburtsDatum = STR_TO_DATE(@GeburtsDatum, '%d.%m.%Y %H:%i:%s')
, LetzteAenderung = STR_TO_DATE(@LetzteAenderung, '%d.%m.%Y %H:%i:%s')
, BeitrittDatum = STR_TO_DATE(@BeitrittDatum, '%d.%m.%Y %H:%i:%s')
, KuendigungDatum = STR_TO_DATE(@KuendigungDatum, '%d.%m.%Y %H:%i:%s')
, AustrittDatum = STR_TO_DATE(@AustrittDatum, '%d.%m.%Y %H:%i:%s')
, BeitragAussetzenVon = STR_TO_DATE(@BeitragAussetzenVon, '%d.%m.%Y %H:%i:%s')
, BeitragAussetzenBis = STR_TO_DATE(@BeitragAussetzenBis, '%d.%m.%Y %H:%i:%s')
/*, BeitragOffenAb = STR_TO_DATE(@BeitragOffenAb, '%e.%c.%Y %H:%i:%s')
, BeitragOffenBis = STR_TO_DATE(@BeitragOffenBis, '%e.%c.%Y %H:%i:%s')
*/, Mahnung1Am = STR_TO_DATE(@Mahnung1Am, '%d.%m.%Y %H:%i:%s')
, Mahnung2Am = STR_TO_DATE(@Mahnung2Am, '%d.%m.%Y %H:%i:%s')
, Mahnung3Am = STR_TO_DATE(@Mahnung3Am, '%d.%m.%Y %H:%i:%s')
, BarZahlungAm = STR_TO_DATE(@BarZahlungAm, '%d.%m.%Y %H:%i:%s')
, InkassoAm = STR_TO_DATE(@InkassoAm, '%d.%m.%Y %H:%i:%s')
, KontaktAm = STR_TO_DATE(@KontaktAm, '%d.%m.%Y %H:%i:%s')
, EinladungIAzum = STR_TO_DATE(@EinladungIAzum, '%d.%m.%Y %H:%i:%s')
, ProbetrainingAm = STR_TO_DATE(@ProbetrainingAm, '%d.%m.%Y %H:%i:%s')
, WTPruefungAm = STR_TO_DATE(@WTPruefungAm, '%d.%m.%Y %H:%i:%s')
, KPruefungAm = STR_TO_DATE(@KPruefungAm, '%d.%m.%Y %H:%i:%s')
, EPruefungAm = STR_TO_DATE(@EPruefungAm, '%d.%m.%Y %H:%i:%s')
, BezahltAm = STR_TO_DATE(@BezahltAm, '%d.%m.%Y %H:%i:%s')
, datumwt1sg = STR_TO_DATE(@datumwt1sg, '%d.%m.%Y %H:%i:%s')
, datumwt2sg = STR_TO_DATE(@datumwt2sg, '%d.%m.%Y %H:%i:%s')
, datumwt3sg = STR_TO_DATE(@datumwt3sg, '%d.%m.%Y %H:%i:%s')
, datumwt4sg = STR_TO_DATE(@datumwt4sg, '%d.%m.%Y %H:%i:%s')
, datumwt5sg = STR_TO_DATE(@datumwt5sg, '%d.%m.%Y %H:%i:%s')
, datumwt6sg = STR_TO_DATE(@datumwt6sg, '%d.%m.%Y %H:%i:%s')
, datumwt7sg = STR_TO_DATE(@datumwt7sg, '%d.%m.%Y %H:%i:%s')
, datumwt8sg = STR_TO_DATE(@datumwt8sg, '%d.%m.%Y %H:%i:%s')
, datumwt9sg = STR_TO_DATE(@datumwt9sg, '%d.%m.%Y %H:%i:%s')
, datumwt10sg = STR_TO_DATE(@datumwt10sg, '%d.%m.%Y %H:%i:%s')
, datumwt11sg = STR_TO_DATE(@datumwt11sg, '%d.%m.%Y %H:%i:%s')
, datumwt12sg = STR_TO_DATE(@datumwt12sg, '%d.%m.%Y %H:%i:%s')
, datumwt1tg = STR_TO_DATE(@datumwt1tg, '%d.%m.%Y %H:%i:%s')
, datumwt2tg = STR_TO_DATE(@datumwt2tg, '%d.%m.%Y %H:%i:%s')
, datumwt3tg = STR_TO_DATE(@datumwt3tg, '%d.%m.%Y %H:%i:%s')
, datumwt4tg = STR_TO_DATE(@datumwt4tg, '%d.%m.%Y %H:%i:%s')
, datumwt5pg = STR_TO_DATE(@datumwt5pg, '%d.%m.%Y %H:%i:%s')
, AufnahmegebuehrBezahltAm = STR_TO_DATE(@AufnahmegebuehrBezahltAm, '%d.%m.%Y %H:%i:%s')
, datumWtPraktikum = STR_TO_DATE(@datumWtPraktikum, '%d.%m.%Y %H:%i:%s')
, datumWtAusbilder1 = STR_TO_DATE(@datumWtAusbilder1, '%d.%m.%Y %H:%i:%s')
, datumWtAusbilder2 = STR_TO_DATE(@datumWtAusbilder2, '%d.%m.%Y %H:%i:%s')
, datumWtAusbilder3 = STR_TO_DATE(@datumWtAusbilder3, '%d.%m.%Y %H:%i:%s')
, datumWtSchulleiter = STR_TO_DATE(@datumWtSchulleiter, '%d.%m.%Y %H:%i:%s')
, datumwt1sgk = STR_TO_DATE(@datumwt1sgk, '%d.%m.%Y %H:%i:%s')
, datumwt2sgk = STR_TO_DATE(@datumwt2sgk, '%d.%m.%Y %H:%i:%s')
, datumwt3sgk = STR_TO_DATE(@datumwt3sgk, '%d.%m.%Y %H:%i:%s')
, datumwt4sgk = STR_TO_DATE(@datumwt4sgk, '%d.%m.%Y %H:%i:%s')
, datumwt5sgk = STR_TO_DATE(@datumwt5sgk, '%d.%m.%Y %H:%i:%s')
, datumwt6sgk = STR_TO_DATE(@datumwt6sgk, '%d.%m.%Y %H:%i:%s')
, datumwt7sgk = STR_TO_DATE(@datumwt7sgk, '%d.%m.%Y %H:%i:%s')
, datumwt8sgk = STR_TO_DATE(@datumwt8sgk, '%d.%m.%Y %H:%i:%s')
, datumwt9sgk = STR_TO_DATE(@datumwt9sgk, '%d.%m.%Y %H:%i:%s')
, datumwt10sgk = STR_TO_DATE(@datumwt10sgk, '%d.%m.%Y %H:%i:%s')
, datumwt11sgk = STR_TO_DATE(@datumwt11sgk, '%d.%m.%Y %H:%i:%s')
, datumwt12sgk = STR_TO_DATE(@datumwt12sgk, '%d.%m.%Y %H:%i:%s')
, datume1sg = STR_TO_DATE(@datume1sg, '%d.%m.%Y %H:%i:%s')
, datume2sg = STR_TO_DATE(@datume2sg, '%d.%m.%Y %H:%i:%s')
, datume3sg = STR_TO_DATE(@datume3sg, '%d.%m.%Y %H:%i:%s')
, datume4sg = STR_TO_DATE(@datume4sg, '%d.%m.%Y %H:%i:%s')
, datume5sg = STR_TO_DATE(@datume5sg, '%d.%m.%Y %H:%i:%s')
, datume6sg = STR_TO_DATE(@datume6sg, '%d.%m.%Y %H:%i:%s')
, datume7sg = STR_TO_DATE(@datume7sg, '%d.%m.%Y %H:%i:%s')
, datume8sg = STR_TO_DATE(@datume8sg, '%d.%m.%Y %H:%i:%s')
, datume9sg = STR_TO_DATE(@datume9sg, '%d.%m.%Y %H:%i:%s')
, datume10sg = STR_TO_DATE(@datume10sg, '%d.%m.%Y %H:%i:%s')
, datume11sg = STR_TO_DATE(@datume11sg, '%d.%m.%Y %H:%i:%s')
, datume12sg = STR_TO_DATE(@datume12sg, '%d.%m.%Y %H:%i:%s')
, DVDgesendetAm = STR_TO_DATE(@DVDgesendetAm, '%d.%m.%Y %H:%i:%s')
, datume11tg = STR_TO_DATE(@datume11tg, '%d.%m.%Y %H:%i:%s')
, datume12tg = STR_TO_DATE(@datume12tg, '%d.%m.%Y %H:%i:%s')
, datume21tg = STR_TO_DATE(@datume21tg, '%d.%m.%Y %H:%i:%s')
, datume22tg = STR_TO_DATE(@datume22tg, '%d.%m.%Y %H:%i:%s')
, datume31tg = STR_TO_DATE(@datume31tg, '%d.%m.%Y %H:%i:%s')
, datume32tg = STR_TO_DATE(@datume32tg, '%d.%m.%Y %H:%i:%s')
, datume41tg = STR_TO_DATE(@datume41tg, '%d.%m.%Y %H:%i:%s')
, datume42tg = STR_TO_DATE(@datume42tg, '%d.%m.%Y %H:%i:%s')
, BeginnEsckrima = STR_TO_DATE(@BeginnEsckrima, '%d.%m.%Y %H:%i:%s')
, EndeEsckrima = STR_TO_DATE(@EndeEsckrima, '%d.%m.%Y %H:%i:%s');
=======
