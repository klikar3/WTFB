...
class Intensiv extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'ziel' => Yii::t('app', 'Goal'),
            'wievielZeit' => Yii::t('app', 'How much time'),
            'trainingsPartner' => Yii::t('app', 'Training Partner'),
            'erstTermin' => Yii::t('app', 'First Appointment on'),
            'einstufung' => Yii::t('app', 'Classification'),
