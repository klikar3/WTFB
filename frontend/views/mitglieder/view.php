...
//			          'style' => 'width: 80px; text-align: left;',
			  ...
			  [
				    'label'=>'<img src="data:image/jpeg;base64,'.base64_encode($thumb ).'" alt="Foto" />', //'" height="100" width="80" alt="Foto"/>',
						'content'=> $this->render('_view_foto', array(
		                                'model'=>$model, 'tabnum' => 10, 
		                        ) ),                                                      
    						'active' => $tabnum == 10?true:false, 
		    ],
