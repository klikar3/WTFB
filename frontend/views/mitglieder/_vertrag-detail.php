...
<?php //if (Yii::$app->user->identity->isAdmin or (Yii::$app->user->identity->username == 'eva')) { ?>
 <div class="row" style="width:300px;margin-bottom:8px;margin-left:0 auto;">
 		<div class="col-sm-1 col-md-1 col-1" id = "wm3.$model->msID"  style="float:left;">
...
*/		?> 
  ...
  <div class="col-sm-2 col-md-2 col-2" id = "sf3.$model->msID"  style="!float:left;padding-right:2em;">  
...
*/
  ...
  <div class="col-sm-2 col-md-2 col-2" id = "bv3.$model->msID" style="!float:right;padding-right:1em;" >  
		<?php //echo Html::checkbox('bl'.$model->msID, $model->BL, ['value' => $model->BL, 'disabled' => false, 'style' => 'width:15px;', 'label' => 'BL', 'labelOptions' => ['style' => 'font-size:0.85em;']]);
			$form4 = ActiveForm::begin([
			    'options'=>['enctype'=>'multipart/form-data', 'name' => 'formbl'.$model->msID], // important
			    'id' => 'formbl'.$model->msID,
   ...
   <div class="col-sm-2 col-md-2 col-2" id = "bl3.$model->msID" style="!float:right;padding-left:3em;" >  
...
//												'value' => $model->OK, 
 ...
 <div class="row" style="width:300px;margin-bottom:8px;margin-left:0 auto;">
  ...
  <div class="col-sm-2 col-md-2 col-2" id = "sf3.$model->msID"  style="!float:right;width:130px;">  
 		<?php	echo Html::mailto('<div class="btn btn-sm btn-default"	style="width: 120px; text-align: left;"><span class="glyphicon glyphicon-envelope"></span>&nbsp;'.Yii::t('app', 'Standard Email').'</div>', Url::to($model->mitglieder->Email) .
 ...
 <div class="row" style="width:300px;margin-bottom:8px;margin-left:0 auto;">
   <div class="col-sm-5 col-md-5 col-5" id = "v1.$model->msID" style="!float:left;width:130px;margin-left:0px;margin-right:8px;">  
		<?php	
			Modal::begin([
			    'header'=>'<center>'.Yii::t('app', 'Upload Contract').'</center>',
					'size'=>'modal-md',
			    'toggleButton' => [
			        'label'=>'<span style="font-size:0.85em"><i class="glyphicon glyphicon-upload"></i> '.Yii::t('app', 'Up Contract').'</span>', 'class'=>'btn btn-default',
			        		'style' => 'width: 120px; text-align: left;',
...
*/        if (($model->schul->swmMitgliederListe != 0 ) && ($model->schul->swmMitgliederForm != 0 )) {
            ...
            echo Html::submitButton('<span class="glyphicon glyphicon-list-alt"></span>&nbsp;'.Yii::t('app', 'Enter into NL').'&nbsp;&nbsp;', ['class' => 'btn btn-sm btn-default', 'title' => 'Enter into Newsletter for Members']);
            echo Html::endForm(); 
					}				
		 } ?>                 
	 </div>
   ...
   <div class="col-sm-2 col-md-2 col-2" id = "bl2.$model->msID" style="!float:left;width:130px;margin-left:0px;margin-right:8px;">  
   	<?php	echo Html::a('<div class="btn btn-sm btn-primary"	style="width: 120px; text-align: left;"><span class="glyphicon glyphicon-envelope"></span>&nbsp;'.Yii::t('app', 'IBAN-Calculator').'</div>', Url::to('https://www.iban-rechner.de'),[
...
*/        if (($model->schul->swmInteressentenListe != 0 ) && ($model->schul->swmInteressentenForm != 0 )) {
            ...
            echo Html::submitButton('<span class="glyphicon glyphicon-list-alt"></span>&nbsp;'.Yii::t('app', 'Exit NL-Int.'), ['class' => 'btn btn-sm btn-default', 'title' => 'Take out of Newsletter for Interested Persons']);
            echo Html::endForm(); 
					}				
		 } ?>                 
	 </div>
