			...
			Modal::begin([
			    ...
			    'toggleButton' => [
			        'label'=>'<span style="font-size:0.85em"><i class="glyphicon glyphicon-upload"></i> Vertrag hoch</span>', 'class'=>'btn btn-default',
			        		'style' => 'width: 120px; text-align: left;',
              'title' => 'Vertrags-Pdf ins Data hochladen', 
			    ],
          'clientOptions' => [
            'backdrop' => 'static',					
          ]
...
*/        if (($model->schul->swmMitgliederListe != 0 ) && ($model->schul->swmMitgliederForm != 0 )) {
            ...
            echo Html::hiddenInput('u_Gender', ($model->mitglieder->Geschlecht == 'männlich') ? 'm' : 'w',['id' => "u_Gender_f"]);
            ...
            echo Html::submitButton('<span class="glyphicon glyphicon-list-alt"></span>&nbsp;In NL eintragen&nbsp;&nbsp;', ['class' => 'btn btn-sm btn-default', 'title' => 'In den Newsletter für Mitglieder eintragen']);
            echo Html::endForm(); 
					}				
		 } ?>                 
	 </div>
...
*/        if (($model->schul->swmInteressentenListe != 0 ) && ($model->schul->swmInteressentenForm != 0 )) {
            ...
            echo Html::submitButton('<span class="glyphicon glyphicon-list-alt"></span>&nbsp;Aus NL-Int. raus', ['class' => 'btn btn-sm btn-default', 'title' => 'Aus dem Newsletter für Interessenten rausnehmen']);
            echo Html::endForm(); 
					}				
		 } ?>                 
	 </div>
