...
<?php if ($model->Schulort == 'WT-Intensiv') {
        echo $this->render('_v_a_person_intensiv', [ 'model' => $model, 'newnr' => $newnr, 'schulen' => $schulen, 'anreden' => $anreden, 'functions' => $functions, 'sifus' => $sifus, 'disziplinen' => $disziplinen, 'schulorte' => $schulorte,]);
        ...
        echo $this->render('_v_a_person_normal', [ 'model' => $model, 'newnr' => $newnr, 'schulen' => $schulen, 'anreden' => $anreden, 'functions' => $functions, 'sifus' => $sifus, 'disziplinen' => $disziplinen, 'schulorte' => $schulorte,]);
