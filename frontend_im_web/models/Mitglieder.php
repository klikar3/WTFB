...
class Mitglieder extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['MitgliederId', 'MitgliedsNr', 'Vorname', 'Name'], 'required'],
            [['MitgliederId', 'VertragMit', 'SFirm', 'BListe'], 'integer'],
            [['MitgliedsNr', 'warZumIAda', 'zumIAnichtDa', 'PTwarDa', 'zumPTnichtDa'], 'string', 'max' => 6],
            [['Vorname', 'Telefon1', 'HandyNr', 'GruppenArt', 'BeitragOffenAb', 'EPruefungAm', 'datumwt4tg', 'datumWtAusbilder1', 'datumWtAusbilder2', 'datumwt3sgk', 'datumwt7sgk', 'datume9sg', 'datume11tg', 'BeginnEsckrima', 'EndeEsckrima'], 'string', 'max' => 18],
            [['Name'], 'string', 'max' => 29],
            [['Geschlecht', 'BLZ', 'Mahngebuehren', 'Vereinbarung', 'VErgaenzungAb', 'AufnGebuehrBetrag', 'EsckrimaGraduierung'], 'string', 'max' => 9],
            [['Anrede'], 'string', 'max' => 11],
            [['GeburtsDatum', 'LetzteAenderung', 'Sifu', 'BeitrittDatum', 'KuendigungDatum', 'AustrittDatum', 'Mahnung1Am', 'Mahnung2Am', 'BarZahlungAm', 'InkassoAm', 'Zahlungsfrist', 'ProbetrainingAm', 'WTPruefungAm', 'KPruefungAm', 'Name2Schule', 'BezahltAm', 'datumwt1sg', 'datumwt2sg', 'datumwt3sg', 'datumwt4sg', 'datumwt5sg', 'datumwt6sg', 'datumwt7sg', 'datumwt8sg', 'datumwt9sg', 'datumwt10sg', 'datumwt11sg', 'datumwt12sg', 'datumwt1tg', 'datumwt2tg', 'datumwt3tg', 'AufnahmegebuehrBezahltAm', 'datumwt1sgk', 'datumwt2sgk', 'datumwt4sgk', 'datumwt5sgk', 'datumwt6sgk', 'datume1sg', 'datume2sg', 'datume3sg', 'datume4sg', 'datume5sg', 'datume6sg', 'datume7sg', 'datume8sg', 'datume10sg', 'datume11sg', 'datume12sg', 'DVDgesendetAm'], 'string', 'max' => 19],
            [['PLZ', 'Fax', 'Schulort', 'VDauer', 'BeitragOffenBis'], 'string', 'max' => 13],
            [['Wohnort'], 'string', 'max' => 25],
            [['Strasse', 'Beruf'], 'string', 'max' => 35],
            ...
            [['Disziplin'], 'string', 'max' => 20],
            [['Funktion', 'Graduierung', 'Zahlungsweise'], 'string', 'max' => 16],
